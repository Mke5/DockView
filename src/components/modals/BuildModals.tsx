      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4 p-4 rounded-2xl bg-brand/5 border border-brand/20 shadow-sm animate-in fade-in duration-500">
          ...
          <div>
            ...
            <span className="text-[10px] font-mono text-brand mt-2 inline-block leading-none font-bold">
              Buildkit Engine v24.0.x
            </span>
          </div>
        </div>
        ...
        <div className="p-4 rounded-xl bg-surface-sunken border border-border-subtle flex gap-3">
          ...
          <p className="text-[10px] text-text-disabled leading-relaxed">
            Sequence will be initiated in the current working directory context.
            Ensure all required assets are accessible.
          </p>
        </div>
