...
mod tests {
    ...
    fn bytes_to_human_gb() {
        ...
        let result = dockview_lib::docker::client::bytes_to_human(2_500_000_000);
        assert_eq!(result, "2.5 GB");
    }

    #[test]
    fn bytes_to_human_mb() {
        let result = dockview_lib::docker::client::bytes_to_human(188_000_000);
        assert_eq!(result, "188 MB");
    }

    #[test]
    fn bytes_to_human_kb() {
        let result = dockview_lib::docker::client::bytes_to_human(4_096);
        assert_eq!(result, "4 KB");
    }

    #[test]
    fn bytes_to_human_bytes() {
        let result = dockview_lib::docker::client::bytes_to_human(512);
        assert_eq!(result, "512 B");
    }

    #[test]
    fn cpu_percent_normal() {
        let pct = dockview_lib::docker::client::cpu_percent(1_000_000.0, 100_000_000.0, 4.0);
        // Should be ~4 %
    ...
    fn cpu_percent_zero_system_delta() {
        let pct = dockview_lib::docker::client::cpu_percent(0.0, 0.0, 4.0);
        assert_eq!(pct, 0.0);
    }
    ...
    fn container_status_from_str() {
        use dockview_lib::docker::models::ContainerStatus;
        assert_eq!(
    ...
    fn restart_policy_as_str() {
        use dockview_lib::docker::models::RestartPolicy;
    ...
    fn command_error_from_anyhow() {
        use dockview_lib::api::utils::CommandError;
    ...
    fn ok_response_with_message() {
        use dockview_lib::api::utils::OkResponse;
